...
export const HEALTHY_CAMPAIGN: Campaign = {
    ...
    backgrounds: [
        {name: "Accountability", color: "#fdedd6", fontColor: "#000000"},
        {name: "Boundaries", color: "#ad89e1", fontColor: "#000000"},
        {name: "Consent", color: "#fdedd6", fontColor: "#000000"},
        {name: "Equality", color: "#5a7424", fontColor: "#000000"},
        {name: "Healthy Conflict", color: "#5a7424", fontColor: "#ffffff"},
        {name: "Honesty", color: "#42347b", fontColor: "#ffffff"},
        {name: "Independence", color: "#fde4d6", fontColor: "#000000"},
        {name: "Joy", color: "#fff9c7", fontColor: "#000000"},
        {name: "Respect", color: "#42347b", fontColor: "#ffffff"},
        {name: "Trust", color: "#2c5996", fontColor: "#ffffff"},
    ],
    sizes: [
        {
            name: "8.5x11",
